...
window.onload = function init()
{
    ...
    function updateM2C () {
        ...
        lightP = object2model.times(rotated2object.times(world2rotated.times(new PV(10, 0, 10, true)))).homogeneous();

        // eyeP is the eye position in the model frame.

        eyeP = object2model.times(rotated2object.times(world2rotated.times(view2world.times(new PV(true))))).homogeneous();
